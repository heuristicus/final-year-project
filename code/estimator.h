...
double** get_subinterval_data(double time, int num_subintervals);
double get_interval_midpoint(int interval_number, double time, int num_subintervals);
double* initialise_weights(int num_subintervals);
double a_estimate(double alpha, double total_time, int num_subintervals);
double b_estimate(double beta, double total_time, int num_subintervals);
...
double constraint_a(double *weights, double *midpoints, double *random_variables, double time, int num_subintervals);
double constraint_b(double *weights, double *midpoints, double *random_variables, double time, int num_subintervals);
void randvar_estimate(double *random_variables, double *midpoints, double a, double b, double time, int num_subintervals);
