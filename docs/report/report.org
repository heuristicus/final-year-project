...
** Experimenter
- explanation of the various bits to do with stuttering and so on
- How data is parsed in and stuff
- how the experiment numbers are incremented
** Launcher
- what thing it uses getopt
- user-friendliness (help output)
- struct usage to improve ease of modification
** Scripts
** Interface
   Usage instructions for the system can be found in Appendix [[Usage]]
* Development
** Development Process
