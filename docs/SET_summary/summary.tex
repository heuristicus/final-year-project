...
proportional to the value of $\lambda(t)$; the probability of adding an event is
small when $\lambda(t)$ is small, and increases with the value of the rate
function.
