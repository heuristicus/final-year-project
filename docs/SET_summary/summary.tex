...
\begin{comment}
    ...
    \end{figure}
\end{comment}
This method gives a better estimate than a simple linear estimate, but results in a piecewise disjoint function rather than a continuous one.
\subsection{Baseline}
\label{sec-4.2}
